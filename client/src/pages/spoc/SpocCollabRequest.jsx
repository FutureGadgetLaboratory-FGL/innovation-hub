    ...
    <div className="flex ">
      ...
      {studentCollabReq.map((item, index) => {
        return (
          <div
            key={index}
            className="w-1/2 p-2 border-2 min-h-full rounded-md shadow-md cursor-pointer"
          >
            ...
            <div className="w-full">
              <div className="flex flex-wrap justify-between w-full">
                ...
                <p className="m-2 font-semibold">Request Details:</p>
                  ...
                  <p className="inline-block font-semibold m-2">
                    Student message:
                  </p>
                  <p className="inline-block m-2 p-2 border border-black">
                    {item.message}
                  </p>
...
export default SpocCollabRequests;

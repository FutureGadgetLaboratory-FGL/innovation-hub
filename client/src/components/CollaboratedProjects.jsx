...
function CollaboratedProjects() {
    return(
        <div className="drop-shadow-md hover:drop-shadow-xl flex flex-col container rounded-md w-1/3 outline-1 outline px-1 m-1">
            ...
            <button className="active:scale-95 mb-1 w-full px-4 py-2 font-semibold text-sm bg-primary hover:bg-primary-light text-white rounded-md shadow-sm">View Collabs</button>
            </Link>
        </div>
    );
}

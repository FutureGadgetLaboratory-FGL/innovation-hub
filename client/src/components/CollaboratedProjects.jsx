...
function CollaboratedProjects() {
    return (
			<div className="bg-white m-3 p-3 flex justify-between flex-col w-1/3 rounded-xl shadow-[rgba(0,0,0,0.1)_0px_15px_20px_0px,rgba(0,0,0,0.04)_0px_10px_10px_-5px]">

		...
		<aside className="w-[17%] h-screen bg-[#f4f5fa] border-r pr-1 sticky top-0">
			...
			{user.user.role === "SPOC" ? (
				<ul className="flex flex-col items-start">
					<li className="ease-in duration-150 text-[#534f5a] text-[1.2rem] font-normal mt-2 w-full mb-[5px] pl-5 pt-[7px] pb-[7px] hover:cursor-pointer hover:bg-[#cccdd1] rounded-[0_50px_50px_0] ">
						<i className="fa-solid fa-house"></i>
						<a href="/">Dashboard</a>
					</li>
					<li className="ease-in duration-150 text-[#534f5a] text-[1.2rem] font-normal w-full mb-[5px] pl-5 pt-[7px] pb-[7px] hover:cursor-pointer hover:bg-[#cccdd1] hover:rounded-[0_50px_50px_0] ">
				...
				<ul className="flex flex-col items-start">
					<NavLink
						to={"/"}
						className="ease-in duration-150 text-[#534f5a] text-[1.2rem] font-normal mt-2 w-full mb-[5px] pl-5 pt-[7px] pb-[7px] hover:cursor-pointer hover:bg-[#cccdd1] rounded-[0_50px_50px_0]"
					>
						<li>
							<i className="fa-solid fa-house"></i>
							Dashboard
					...
					<NavLink
						to={"/spoc_collab_requests"}
						className="ease-in duration-150 text-[#534f5a] text-[1.2rem] font-normal w-full mb-[5px] pl-5 pt-[7px] pb-[7px] hover:cursor-pointer hover:bg-[#cccdd1] rounded-[0_50px_50px_0] active:text-[white] active:bg-gradient-to-r active: from-accent-lpurple active: to-accent-dpurple"
					>
						<li>
							Competitions
						</li>

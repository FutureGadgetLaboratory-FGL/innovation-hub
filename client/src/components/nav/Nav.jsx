...
const Nav = () => {
	...
	return (
		<nav className="w-[100%] h-[70px] bg-background flex justify-between pl-9 rounded-lg pr-20  items-center">
				...
				<div className="w-[300px] mx-auto ">
					<div className="relative w-[300px] h-[40px]">
						<input
							...
							class="input"
							placeholder="search..."
							className="text-[#8b7d77] rounded-lg border-0 absolute w-full h-full text-lg px-5 py-2.5 rounded-[3px] left-0 top-0"
						/>
						<div className="bg-slate-700 absolute w-[60px] h-full z-[1] cursor-pointer  right-0 top-0">
							<FontAwesomeIcon
								icon="fas fa-search"
								className="absolute   -translate-x-2/4 -translate-y-2/4 text-white text-[20px] left-2/4 top-2/4"
							/>
						</div>
					</div>
				</div>
			...
			<div className={`absolute w-[100%] h-[100vh] top-0 left-0 z-999 ${modal}`} id="modal">
				<div className={`absolute top-[60px] right-[60px] w-[160px] h-[200px] bg-slate-200 rounded p-3 `}>

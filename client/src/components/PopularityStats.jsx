...
import { getAllUniversities } from '../redux/actions/universityActions';
function PopularityStats() {
    ...
    // }, [dispatch]);
    // const university = useSelector(state => state.user.user.university);
    // const universityData = university.popularity;
